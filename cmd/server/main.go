...
func main() {
	...
	commandMode := vertexImport != "" || antigravityLogin || codexLogin || codexDeviceLogin || claudeLogin || kimiLogin || kimiAILogin || xaiLogin || devinLogin || metaLogin || cursorLogin || cursorAPIKey != ""
...
func argvFlagConsumesValue(name string) bool {
	...
	case "codex-login", "codex-device-login", "claude-login", "no-browser",
		"antigravity-login", "kimi-login", "kimi-ai-login", "xai-login", "devin-login", "meta-login", "cursor-login", "cursor-api-key",
