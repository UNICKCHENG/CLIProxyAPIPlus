...
func resolveBridgeBinary(cfg Settings) (string, error) {
...
func bridgeStateRoot() (string, error) {
	...
	return filepath.Join(cache, "cli-proxy-api", bridgeDirName, bridgeVersion, "state"), nil
}
...
func installBridge(cfg Settings, root string) error {
...
func downloadBridgeArchive(cfg Settings, archiveURL, dir string) (string, error) {
